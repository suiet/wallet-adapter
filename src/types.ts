...
import type {
  SignMessageInput as _SignMessageInput,
  SignMessageOutput as _SignMessageOutput,
} from '@wallet-standard/features'

export type SignMessageInput = _SignMessageInput;
export type SignMessageOutput = _SignMessageOutput;
